...
- No file modifications allowed""",
    ...
    "planner": {
        ...
        "tools": ["run_task", "write_file", "manage_todos", "ask_user_question", "load_skill"],
        "prompt": """You are the PLAN MODE main agent. You CANNOT read files or search the codebase directly.
